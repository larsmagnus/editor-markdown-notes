...
import { alignColumn } from '@/editor/table/alignment'
import type { TableAlign } from '@/editor/table/alignment'
import { moveCaretPastTable, moveCaretToCellBeyond } from '@/editor/table/caret'
import {
	removeCellSelection,
	selectCellBeside,
} from '@/editor/table/cell-selection'
import { keepHeaderInFirstRow } from '@/editor/table/header'
