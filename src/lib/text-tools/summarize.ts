...
export type Summary = {
	...
	/** The document's overall reading difficulty, gated on the `readability` rule. */
	overallReadability: Analysis['overallReadability']
}
...
export function summarize(
	...
	return {
		...
		overallReadability: enabled.has('readability')
