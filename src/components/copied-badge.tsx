...
export type CopiedBadgeSide = 'top' | 'right' | 'bottom' | 'left'

type CopiedBadgeProps = { show: boolean; side?: CopiedBadgeSide }
 ...
 */
const SIDE_CLASSES: Record<CopiedBadgeSide, string> = {
 ...
 */
export function CopiedBadge({ show, side = 'left' }: CopiedBadgeProps) {
	if (!show) return null
