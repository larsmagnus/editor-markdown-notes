 ...
 * fractions and overall verdict, plus polarity's overall temperature and dash
 * overuse's rate, each only when its rule ran and found something.
 */
export function summaryLines(
	...
	if (ruleSummary.overallReadability)
		lines.push(ruleSummary.overallReadability.text)
